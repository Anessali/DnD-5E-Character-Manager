...
namespace CharacterSheet {
    ...
    public partial class DnDataDataSet : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public InventoryRow AddInventoryRow(string Item, int Quantity, string Type) {
        ...
        public partial class RacesDataTable : global::System.Data.TypedTableBase<RacesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public RacesRow AddRacesRow(int Id, string Name, int Speed, int Strength, int Dexterity, int Constitution, int Intelligence, int Wisdom, int Charisma, string Trait1, string Trait2, string Trait3, string Trait4) {
...
namespace CharacterSheet.DnDataDataSetTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([Item], [Quantity], [Type]) VALUES (@Item, @Quanti" +
                "ty, @Type);\r\nSELECT Id, Item, Quantity, Type FROM Inventory WHERE (Id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [Item] = @Item, [Quantity] = @Quantity, [Type] = @Type WHERE (([Id] = @Original_Id) AND ((@IsNull_Item = 1 AND [Item] IS NULL) OR ([Item] = @Original_Item)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)));
SELECT Id, Item, Quantity, Type FROM Inventory WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Item, Quantity, Type FROM dbo.Inventory";
        ...
        public virtual int Insert(string Item, global::System.Nullable<int> Quantity, string Type) {
            if ((Item == null)) {
        ...
        public virtual int Update(string Item, global::System.Nullable<int> Quantity, string Type, int Original_Id, string Original_Item, global::System.Nullable<int> Original_Quantity, string Original_Type, int Id) {
            if ((Item == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item, global::System.Nullable<int> Quantity, string Type, int Original_Id, string Original_Item, global::System.Nullable<int> Original_Quantity, string Original_Type) {
            return this.Update(Item, Quantity, Type, Original_Id, Original_Item, Original_Quantity, Original_Type, Original_Id);
        }
    }
    ...
    public partial class RacesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Races] ([Id], [Name], [Speed], [Strength], [Dexterity], [Constitution], [Intelligence], [Wisdom], [Charisma], [Trait1], [Trait2], [Trait3], [Trait4]) VALUES (@Id, @Name, @Speed, @Strength, @Dexterity, @Constitution, @Intelligence, @Wisdom, @Charisma, @Trait1, @Trait2, @Trait3, @Trait4);
...
SELECT Id, Name, Speed, Strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma, Trait1, Trait2, Trait3, Trait4 FROM Races WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string Name, global::System.Nullable<int> Speed, global::System.Nullable<int> Strength, global::System.Nullable<int> Dexterity, global::System.Nullable<int> Constitution, global::System.Nullable<int> Intelligence, global::System.Nullable<int> Wisdom, global::System.Nullable<int> Charisma, string Trait1, string Trait2, string Trait3, string Trait4) {
        ...
        public virtual int Update(
                    ...
                    string Original_Trait3, 
                    string Original_Trait4) {
            return this.Update(Original_Id, Name, Speed, Strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma, Trait1, Trait2, Trait3, Trait4, Original_Id, Original_Name, Original_Speed, Original_Strength, Original_Dexterity, Original_Constitution, Original_Intelligence, Original_Wisdom, Original_Charisma, Original_Trait1, Original_Trait2, Original_Trait3, Original_Trait4);
        }
    }
